...
class link_list{
    ...
    node* interestLists(node *list1_head, node *list2_head){ //results contains intersection of two lists
        node *i= list1_head;
        node *j= list2_head;
...
int main(){
    ...
    displayList(interestLists(list1.head,list2.head));
	cout << "                                                       " << endl; 
